...
import { KalkulationComponent } from 'app/entities/kalkulation/kalkulation.component';
...
describe('Component Tests', () => {
  describe('Kalkulation Management Component', () => {
    let comp: KalkulationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(KalkulationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.kalkulations && comp.kalkulations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
